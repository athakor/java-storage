...
public class StorageImplTest {
  ...
  public void testGetNotification() {
    ...
    EasyMock.expect(storageRpcMock.getNotification(BUCKET_NAME1, id)).andReturn(notification);
    EasyMock.replay(storageRpcMock);
    initializeService();
    Notification remoteNotification = storage.getNotification(BUCKET_NAME1, id);
